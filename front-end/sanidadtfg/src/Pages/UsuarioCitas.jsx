...
export default function UsuarioCitas() {
  ...
  function obtenerCitasPasadas() {
    axios
      .get("http://localhost:8080/cita/listar/pasadasUsuario/" + user.id, {
        headers: {
  ...
  function obtenerCitasProximas() {
    axios
      .get("http://localhost:8080/cita/listar/proximasUsuario/" + user.id, {
        headers: {
          Authorization: token[0],
        },
      })
